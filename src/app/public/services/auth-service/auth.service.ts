  ...
  */
  register(registerRequest: RegisterRequest): Observable<RegisterResponse> {
    ...
    return of(fakeRegisterResponse).pipe(
      ...
      tap((res: RegisterResponse) => this.snackbar.open(`Check your email for login instructions.`, 'Close', {
        duration: 2000, horizontalPosition: 'right', verticalPosition: 'top'
      })));
  ...
  showGuestMessage() {
    this.snackbar.open('You are browsing as a guest. Log in to bookmark events.', 'Close', {
      duration: 3000,
